...
stories.addDecorator(defaultTemplate({
  title: 'Canvas View',
  documentationLink: 'http://www.patternfly.org/pattern-library/content-views/canvas-view/#/design'
}))

stories.addWithInfo('canvas with top-aligned toolbox', `This is the Canvas View with a top-aligned toolbox.`, () => {
  return (
    <MockCanvasManager />
  )
})

stories.addWithInfo('canvas with droppable projects', `This is the Canvas View with droppable project nodes.`, () => {
  return (
    <MockProjectCanvasManager />
  )
})
...
stories.addWithInfo('canvas top aligned toolbox', `This is the Canvas Top Aligned Toolbox.`, () => {
  // toolbox knobs
  ...
  return (
    <CanvasLayout>
      <div className='canvas-editor-toolbox-container'>
        <CanvasTopAlignedToolbox isOpen={toolboxOpen} closeClicked={action('closeClicked')} >
