...
var StatefulWizardPattern = function (_React$Component) {
  ...
  _createClass(StatefulWizardPattern, [{
    ...
    value: function onStepChanged(newStepIndex) {
      ...
      if (shouldPreventStepChange(activeStepIndex, newStepIndex) || shouldPreventExit && shouldPreventExit(newStepIndex) || shouldPreventEnter && shouldPreventEnter(activeStepIndex)) return;
...
StatefulWizardPattern.propTypes = _extends({}, _WizardPattern2.default.propTypes, {
  steps: _propTypes2.default.arrayOf(_propTypes2.default.shape(_extends({}, _WizardPatternConstants.stepShape, {
