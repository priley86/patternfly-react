  ...
  _createClass(CardHeightMatching, [{
    ...
    value: function componentDidMount() {
      ...
      this._selectors.forEach(function (selector) {
        ...
        _this2._resizeSensors.push(new _cssElementQueries.ResizeSensor(elements, (0, _helpers.debounce)(_this2._matchHeights([selector]), 200)));
      });
...
CardHeightMatching.propTypes = {
  ...
  selector: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.arrayOf(_propTypes2.default.string)]).isRequired
};
CardHeightMatching.defaultProps = {
  className: ''
};
exports.default = CardHeightMatching;